...
- Format: PDF
- Source: `Source/02-slides/session-07-slides.md`
- Audience: live classroom delivery
- Purpose: presentation-ready deck for Session 07

Suggested filename:

- `Session-07-Context-Control-via-CLAUDE-md-Slides.pdf`
...
- Purpose: speaking notes, pacing, configuration guidance, live-demo sequence, and teaching intent

Suggested filename:

- `Session-07-Context-Control-via-CLAUDE-md-Facilitator-Brief.docx`
...
- `Session-07-Context-Control-via-CLAUDE-md-Participant-Handout.docx`
...
- `Session-07-Context-Control-via-CLAUDE-md-Reading-List.docx`
...
- persistent rules are part of the harness, not part of a temporary prompt
- `CLAUDE.md` should encode stable constraints, conventions, and review expectations
- scope matters: user, project, local, and managed rules solve different problems
- the goal is less repetition, less variance, and stronger team-wide consistency

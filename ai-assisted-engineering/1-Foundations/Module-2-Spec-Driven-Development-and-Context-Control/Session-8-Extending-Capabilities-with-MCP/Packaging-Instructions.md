...
- Format: PDF
- Source: `Source/02-slides/session-08-slides.md`
- Audience: live classroom delivery
- Purpose: presentation-ready deck for Session 08

Suggested filename:

- `Session-08-Extending-Capabilities-with-MCP-Slides.pdf`
...
- Purpose: speaking notes, pacing, MCP framing, live-demo sequence, and teaching intent

Suggested filename:

- `Session-08-Extending-Capabilities-with-MCP-Facilitator-Brief.docx`
...
- `Session-08-Extending-Capabilities-with-MCP-Participant-Handout.docx`
...
- `Session-08-Extending-Capabilities-with-MCP-Reading-List.docx`
...
- MCP is the integration layer for connecting agents to tools and systems
- open protocols reduce brittle one-off integrations and vendor lock-in
- MCP access must be treated as a security boundary, not just a convenience feature
- teams should understand what context and authority a tool call actually carries

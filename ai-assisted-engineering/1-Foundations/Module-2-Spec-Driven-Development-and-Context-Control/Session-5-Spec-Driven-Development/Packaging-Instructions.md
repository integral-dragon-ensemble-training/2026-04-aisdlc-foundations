...
- Format: PDF
- Source: `Source/02-slides/session-05-slides.md`
- Audience: live classroom delivery
- Purpose: presentation-ready deck for Session 05

Suggested filename:

- `Session-05-Spec-Driven-Development-Slides.pdf`
...
- Purpose: speaking notes, pacing, live-demo sequence, and teaching intent

Suggested filename:

- `Session-05-Spec-Driven-Development-Facilitator-Brief.docx`
...
- `Session-05-Spec-Driven-Development-Participant-Handout.docx`
...
- `Session-05-Spec-Driven-Development-Reading-List.docx`
...
- specification discipline is upstream quality control
- acceptance criteria must be binary and reviewable
- specs reduce rework and improve planning quality
- the agent is not the source of truth; the spec is

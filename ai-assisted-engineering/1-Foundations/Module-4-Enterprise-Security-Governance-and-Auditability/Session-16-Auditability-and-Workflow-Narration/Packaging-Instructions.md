...
- Format: PDF
- Source: `Source/02-slides/session-16-slides.md`
- Audience: live classroom delivery
- Purpose: presentation-ready deck for Session 16

Suggested filename:

- `Session-16-Auditability-and-Workflow-Narration-Slides.pdf`
...
- Purpose: speaking notes, pacing, auditability framing, live-demo sequence, and teaching intent

Suggested filename:

- `Session-16-Auditability-and-Workflow-Narration-Facilitator-Brief.docx`
...
- `Session-16-Auditability-and-Workflow-Narration-Participant-Handout.docx`
...
- `Session-16-Auditability-and-Workflow-Narration-Reading-List.docx`
...
- the team must be able to explain why the system did what it did
- narration is part of the engineering record, not optional commentary
- logs, trace evidence, and PR notes should make the workflow reconstructable
- a successful outcome still needs a defensible paper trail

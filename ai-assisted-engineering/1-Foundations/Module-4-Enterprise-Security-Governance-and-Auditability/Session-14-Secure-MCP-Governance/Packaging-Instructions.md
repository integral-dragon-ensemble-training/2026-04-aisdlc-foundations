...
- Format: PDF
- Source: `Source/02-slides/session-14-slides.md`
- Audience: live classroom delivery
- Purpose: presentation-ready deck for Session 14

Suggested filename:

- `Session-14-Secure-MCP-Governance-Slides.pdf`
...
- Purpose: speaking notes, pacing, threat-modeling guidance, live-demo sequence, and teaching intent

Suggested filename:

- `Session-14-Secure-MCP-Governance-Facilitator-Brief.docx`
...
- `Session-14-Secure-MCP-Governance-Participant-Handout.docx`
...
- `Session-14-Secure-MCP-Governance-Reading-List.docx`
...
- MCP server trust should be explicit, scoped, and auditable
- security controls belong at the server, credential, and transport layers, not only in the prompt
- read-only should be the default for first exposure
- governance should prevent data poisoning and exfiltration through tool access

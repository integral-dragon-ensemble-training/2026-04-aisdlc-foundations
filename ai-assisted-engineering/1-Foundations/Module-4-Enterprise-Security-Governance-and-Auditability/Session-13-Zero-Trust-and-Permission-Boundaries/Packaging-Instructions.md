...
- Format: PDF
- Source: `Source/02-slides/session-13-slides.md`
- Audience: live classroom delivery
- Purpose: presentation-ready deck for Session 13

Suggested filename:

- `Session-13-Zero-Trust-and-Permission-Boundaries-Slides.pdf`
...
- Purpose: speaking notes, pacing, permissioning guidance, live-demo sequence, and teaching intent

Suggested filename:

- `Session-13-Zero-Trust-and-Permission-Boundaries-Facilitator-Brief.docx`
...
- `Session-13-Zero-Trust-and-Permission-Boundaries-Participant-Handout.docx`
...
- `Session-13-Zero-Trust-and-Permission-Boundaries-Reading-List.docx`
...
- the agent is not a trusted peer; it is a privileged but constrained system component
- permissions should be explicit, minimal, and reviewable
- `--dangerously-skip-permissions` is an anti-pattern, not a productivity trick
- Zero Trust means assumptions are continuously verified at the control boundary

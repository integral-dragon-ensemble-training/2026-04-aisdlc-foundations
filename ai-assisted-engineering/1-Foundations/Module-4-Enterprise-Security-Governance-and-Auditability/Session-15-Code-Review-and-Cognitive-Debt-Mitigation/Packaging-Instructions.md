...
- Format: PDF
- Source: `Source/02-slides/session-15-slides.md`
- Audience: live classroom delivery
- Purpose: presentation-ready deck for Session 15

Suggested filename:

- `Session-15-Code-Review-and-Cognitive-Debt-Mitigation-Slides.pdf`
...
- Purpose: speaking notes, pacing, review workflow, live-demo sequence, and teaching intent

Suggested filename:

- `Session-15-Code-Review-and-Cognitive-Debt-Mitigation-Facilitator-Brief.docx`
...
- `Session-15-Code-Review-and-Cognitive-Debt-Mitigation-Participant-Handout.docx`
...
- `Session-15-Code-Review-and-Cognitive-Debt-Mitigation-Reading-List.docx`
...
- diff review must look beyond syntax and test status
- automation bias can cause humans to accept AI output too quickly
- cognitive debt accumulates when reviewers approve code they do not understand
- the review should name structural risk, not just defects

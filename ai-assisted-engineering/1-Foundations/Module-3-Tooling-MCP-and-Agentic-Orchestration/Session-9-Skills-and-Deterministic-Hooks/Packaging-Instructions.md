...
- Format: PDF
- Source: `Source/02-slides/session-09-slides.md`
- Audience: live classroom delivery
- Purpose: presentation-ready deck for Session 09

Suggested filename:

- `Session-09-Skills-and-Deterministic-Hooks-Slides.pdf`
...
- Purpose: speaking notes, pacing, policy framing, live-demo sequence, and teaching intent

Suggested filename:

- `Session-09-Skills-and-Deterministic-Hooks-Facilitator-Brief.docx`
...
- `Session-09-Skills-and-Deterministic-Hooks-Participant-Handout.docx`
...
- `Session-09-Skills-and-Deterministic-Hooks-Reading-List.docx`
...
- skills provide reusable guidance and workflow acceleration
- hooks provide deterministic enforcement at lifecycle boundaries
- teams should not rely on the model to remember mandatory checks
- enforcement should move from good intentions into configured controls

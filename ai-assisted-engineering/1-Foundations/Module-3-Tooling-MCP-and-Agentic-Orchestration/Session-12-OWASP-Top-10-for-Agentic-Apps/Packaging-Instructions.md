...
- Format: PDF
- Source: `Source/02-slides/session-12-slides.md`
- Audience: live classroom delivery
- Purpose: presentation-ready deck for Session 12

Suggested filename:

- `Session-12-OWASP-Top-10-for-Agentic-Apps-Slides.pdf`
...
- Purpose: speaking notes, pacing, threat-modeling prompts, and teaching intent

Suggested filename:

- `Session-12-OWASP-Top-10-for-Agentic-Apps-Facilitator-Brief.docx`
...
- `Session-12-OWASP-Top-10-for-Agentic-Apps-Participant-Handout.docx`
...
- `Session-12-OWASP-Top-10-for-Agentic-Apps-Reading-List.docx`
...
- the agentic threat model shifts from bad text to bad action
- prompt injection, tool misuse, identity spoofing, and memory poisoning are active risks
- security must be evaluated at the execution and tool layers, not only at the prompt layer
- enterprise teams need explicit threat modeling, not generic reassurance

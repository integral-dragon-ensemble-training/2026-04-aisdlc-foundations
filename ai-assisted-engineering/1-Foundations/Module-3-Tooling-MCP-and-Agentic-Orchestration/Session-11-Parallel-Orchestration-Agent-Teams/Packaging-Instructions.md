...
- Format: PDF
- Source: `Source/02-slides/session-11-slides.md`
- Audience: live classroom delivery
- Purpose: presentation-ready deck for Session 11

Suggested filename:

- `Session-11-Parallel-Orchestration-Agent-Teams-Slides.pdf`
...
- Purpose: speaking notes, pacing, orchestration guidance, live-demo sequence, and teaching intent

Suggested filename:

- `Session-11-Parallel-Orchestration-Agent-Teams-Facilitator-Brief.docx`
...
- `Session-11-Parallel-Orchestration-Agent-Teams-Participant-Handout.docx`
...
- `Session-11-Parallel-Orchestration-Agent-Teams-Reading-List.docx`
...
- agent teams are for genuinely parallel work with coordination value
- teams differ from subagents because teammates can communicate directly and share a task system
- parallelism increases token and coordination cost, so team size and task sizing matter
- the lead remains responsible for steering, approval, and cleanup

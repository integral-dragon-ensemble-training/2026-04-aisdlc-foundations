...
This handout contains the core exercise for Day 1 plus one lightweight in-class activity. Both use the "what good looks like" framework as their anchor.
...
- The Repository Health Scorecard (see `session-1-rubric.md`).

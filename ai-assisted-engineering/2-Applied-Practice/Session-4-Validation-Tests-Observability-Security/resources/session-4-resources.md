# Session 4 — Curated Readings

Readings for the validation day: tests, observability, security, and supply-chain hygiene. These are references for students who want to go deeper, and for instructors who want to ground claims in primary sources.
...
Why it is on the list: a concise breakdown of traces, metrics, logs, and related concepts. Good reference when students ask "what belongs in which signal type?"
...
## Repositories worth showing on Day 4
...
Why it is on the list: an easy way to show students what good CI starting points look like, including security scanning and dependency review wiring.

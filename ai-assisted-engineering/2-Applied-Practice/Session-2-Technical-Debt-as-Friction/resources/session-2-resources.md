...
Curated readings to support Session 2: Technical Debt as Friction. These sources sharpen the distinction between local code smells and broader project debt, ground the "interest" metaphor in operational reality, and give students a vocabulary for documenting engineering quality.
...
- Helps students see that a smell is a surface-level hint, not the whole problem.
...
- Introduced briefly in Session 1; worth a re-read before Session 2 if students want the original source.
...
- Useful in debrief when students want to distinguish deliberate debt from accidental debt.
...
- Scan **Twelve-Factor App** before the Friction Map exercise — it helps students spot environment, config, and release debt they would otherwise miss.

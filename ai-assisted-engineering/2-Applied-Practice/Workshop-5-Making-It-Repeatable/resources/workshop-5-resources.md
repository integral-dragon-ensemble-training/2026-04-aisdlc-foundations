...
Curated readings and references for Workshop 5: *Making It Repeatable*. The focus is on release discipline, commit hygiene, and workflow automation that support a repeatable improvement practice.
...
## Supporting references (from earlier workshops)

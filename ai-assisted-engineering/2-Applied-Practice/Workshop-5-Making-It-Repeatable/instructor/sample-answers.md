# Sample Answers — Workshop 5: Making It Repeatable

Use these notes to calibrate review of participant work. The goal is to show instructors what "good" looks like, not to give participants a template to imitate.

---

## Strong Workshop 5 plans usually include
...
### Context (given by the participant group)
...
- **Rescore the repo health scorecard** and compare against the baseline captured in Workshop 1.
...
- The check-in uses a real baseline from Workshop 1 and a specific metric.
...
## Common weak patterns across the workshops

*(From sample-answer-guidance.md — reinforce on Workshop 5 as the final synthesis.)*

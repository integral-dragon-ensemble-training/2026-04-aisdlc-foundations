...
These exercises convert everything from Workshops 1–4 into an executable near-term plan and a disciplined, repeatable workflow.
...
Group (3–5 participants per team).

**Inputs required**

- Workshop 1 repository health scorecard,
- Workshop 2 friction map and debt inventory,
- Workshop 3 notes (docs gaps, architecture map, test ideas),
- Workshop 4 validation review (observability gaps, refactor review),
...
Individual thinking, then group vote, then short debate on the tightest cases.

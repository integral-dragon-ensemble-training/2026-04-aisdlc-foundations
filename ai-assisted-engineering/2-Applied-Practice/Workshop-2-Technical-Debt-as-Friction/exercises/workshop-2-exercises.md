...
This workshop's work centers on turning vague complaints into a categorized, prioritized technical debt inventory. One core group exercise is supported by two short lightweight activities.
...
- Repo health notes from Workshop 1 (or a public / training repo you have access to).
...
Give participants the list below and ask them to sort each item into one of four buckets:

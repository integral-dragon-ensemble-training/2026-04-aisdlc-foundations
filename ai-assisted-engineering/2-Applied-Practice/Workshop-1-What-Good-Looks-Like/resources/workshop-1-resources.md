...
Curated readings and example repositories for Workshop 1: **What Good Looks Like**.
...
- Good supporting material if participants ask "what would this look like in practice?"

---

## Example repositories

Public GitHub repositories suitable for Workshop 1 repo tours and the scorecard exercise.
...
**Caveat** — big enough that participants can get lost unless you guide the tour.

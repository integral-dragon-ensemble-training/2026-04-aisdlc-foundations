# Workshop 3 — Discussion Prompts

These are the workshop's prompts. Use them to open the workshop, transition between slides, or anchor the debrief after the exercises.

## Primary prompts (Workshop 3)

- **What AI tasks are genuinely high leverage in your environment?**
  Push participants past "code completion." Listen for the tasks that fit the capability map: repo summarization, test scaffolding, docs drafts, refactor prep.
...
- **What would an AI have to produce for you to trust it with a PR?**
  Forces participants to articulate their own review bar. Most will realize they have not stated one explicitly.
...
Ask every participant to put one answer in each bucket. Capture the class pattern on the board. Don't adjudicate disagreements — the disagreements are the artifact.

## Prompt-for-the-prompts

If the room is quiet, pick a single repository visible in the workshop (public or participant-provided) and run one question against it live:
...
Let the class critique the answer. Most of the workshop's lessons surface in five minutes of that critique.

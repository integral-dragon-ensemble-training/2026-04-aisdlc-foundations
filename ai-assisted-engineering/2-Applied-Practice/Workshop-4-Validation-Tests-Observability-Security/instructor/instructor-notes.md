# Workshop 4 — Instructor Notes

## What this workshop is for

Workshop 4 is the guardrail workshop. It exists because a plausible AI-generated diff is not a safe diff, and because most teams over-trust fluency and under-trust evidence. The core claim of the workshop:

> AI-generated change + validation = trustworthy improvement.

If participants leave with one line, it is that one.
...
## Places participants are likely to push back
...
- Get to the **Refactoring Review exercise** with at least 20 minutes left. It is where the workshop lands.
...
## Good closing language for Workshop 4

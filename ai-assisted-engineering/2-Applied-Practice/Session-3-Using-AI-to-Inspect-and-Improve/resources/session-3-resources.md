...
Curated readings for Session 3. These anchor the day's teaching points about what AI coding tools are actually designed to do, how to shape prompts for real engineering work, and what expected capabilities look like across Claude Code, Gemini Code Assist, and GitHub Copilot's coding agent.
...
- Concrete example of a coding agent that operates asynchronously against a repo and produces a reviewable PR — directly reinforces the session's "small, scoped, reviewable" framing.
...
- **Pre-session (optional):** skim the overview pages for whichever tool your team uses in practice.
...
- **After the session:** pick one tool and commit to a single concrete workflow for the coming week, rather than sampling all three superficially.

## Related assets

- **Student Prompt Template for Codebase Analysis** — `exercises/session-3-prompt-template.md`
- **Session 3 Exercises** — `exercises/session-3-exercises.md`
- **Session 3 Slides** — `slides/session-3-slides.html`

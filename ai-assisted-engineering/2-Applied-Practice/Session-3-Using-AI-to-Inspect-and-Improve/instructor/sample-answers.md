# Session 3 — Sample Answer Guidance

Use these notes while reviewing student work on the Day 3 exercises. The strong Day 3 pattern is simple: **structured, uncertain, evidence-grounded.**

## Strong Day 3 outputs usually include
...
- **Avoidance of sweeping refactor claims.** If the student's output recommends a big rewrite, they have missed the lesson.
- **Visible edits to AI output.** A student who accepts the AI draft unchanged is not demonstrating the skill of the day.
...
- The "questions still unanswered" section is non-empty and is focused on things the repo does not answer, not things the student did not read.
...
## Common weak patterns across Day 3
...
Most students will produce something imperfect on Day 3 — that is fine. The grading question is:
...
If those three are present, the day worked.
